...
assert.match(renderer, /const firstLimitStateWindowID = visibleWindows\.find/);
assert.match(renderer, /const warning = serverWarning \|\| quotaWarning\(ratio\);/);
assert.match(renderer, /workspace_member_usage_limit_reached/);
assert.match(renderer, /function displayWindowLabel\(window\)/);
assert.match(renderer, /function escapeHTML\(value\)/);
