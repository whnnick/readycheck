...
final class LocalizationServiceTests: XCTestCase {
    func testEnglishAndChineseContainRequiredKeys() {
        let requiredKeys = [
            ...
            "oauth.status.credentialStorageFailed",
            "settings.notchStatus",
            "settings.notchStatusHelp",
            "settings.notchStatusUnavailable",
            "notch.openMainWindow",
            "quota.currentSevenDayUnavailable",
            "oauth.status.failed",
            ...
            "oauth.error.callbackFailedDetail",
            "oauth.error.tokenExchangeFailed",
            "oauth.error.tokenExchangeFailedStatus",
            "oauth.error.tokenExchangeFailedDetail",
            "oauth.error.invalidTokenResponse",
            "oauth.error.credentialStorageFailed",
            "oauth.error.credentialStorageFailedStatus",
            "oauth.error.keychainUnavailable",
            "oauth.error.network",
            ...
            "notification.settings.temporary",
