...
> Status: `0.1.54` is an early macOS preview. Codex OAuth is the only supported provider in this release. Windows and other providers are planned, not included.
...
Download `ReadyCheck-0.1.54-macos.dmg` from the [latest release](https://github.com/whnnick/readycheck/releases/latest), open the DMG, and drag `ReadyCheck.app` to Applications.
...
The DMG is written to `dist/ReadyCheck-0.1.54-macos.dmg`.
